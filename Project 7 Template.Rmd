...
#am I making the treatment variable correctly?
...
```{r}
#drop <- c("year_adopted","(year_adopted = ifelse(is.na(year_adopted), Inf, year_adopted))" , "trt")
#medicaid_expansion = medicaid_expansion[,!(names(medicaid_expansion) %in% drop)]
...
- **Answer**: We do see evidence that early adopters--states that implemented a Medicaid expansion between 2014 and 2016--experienced a larger decrease in their uninsured population. Using a multisynth model with time cohort, we see that states that implemented the expansion in 2015 and 2016 appear to have exprienced the strongest treatment effects. 
